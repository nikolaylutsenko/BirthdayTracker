...
namespace BirthdayTracker.Backend.Migrations
{
    ...
    [Migration("20220122221527_CustomizeIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BirthdayTracker.Backend.Models.AppRole", b =>
                {
            ...
            modelBuilder.Entity("BirthdayTracker.Backend.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BirthdayTracker.Backend.Models.AppUserAppRole", b =>
                {
            ...
            modelBuilder.Entity("BirthdayTracker.Shared.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BirthdayTracker.Backend.Models.AppUserAppRole", b =>
                {
                    b.HasOne("BirthdayTracker.Backend.Models.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BirthdayTracker.Backend.Models.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("BirthdayTracker.Backend.Models.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BirthdayTracker.Backend.Models.AppUser", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
